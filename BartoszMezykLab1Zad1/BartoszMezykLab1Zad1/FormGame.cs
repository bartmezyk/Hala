...
namespace BartoszMezykLab1Zad1
{
    public partial class FormGame : Form
    {
        ...
        private void ShowRates()
        {
            ...
            //labelAccountingOfficeLevel.Text = levelAccountingOffice + "/3";
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void pictureBoxBuyEquipement_Click(object sender, EventArgs e)
        {
        ...
        private void StringsUpdate()
        {
            ...
            pictureBoxMakeOffer.Text = "Zorganizuj promocję (" + costOffer + " zł)";
        }
        ...
        private void CostLevelUp()
        {
            ...
            if (levelRestaurant == 10)
            {
                ...
                labelExtendRestaurant.Text = "MAKSYMALNY POZIOM ROZBUDOWY RESTAURACJI";
                    ...
                    if (levelAccountingOffice != 3)
                    {
                        ...
                        if (costAccountingOffice <= money)
                        {
                            ...
                            else
                            {
                                ...
                                labelHireAccountingOffice.Text = "MAKSYMALNY POZIOM BIURA RACHUNKOWEGO";

                                // Wyłączenie przycisku dotyczącego zwiększenia poziomu wynajętego biura rachunkowego
                                labelHireAccountingOffice.Enabled = false;
                            }
